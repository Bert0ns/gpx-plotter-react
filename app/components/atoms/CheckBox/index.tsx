  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <div
          className={`w-5 h-5 border-2 rounded-md transition-all duration-200 ease-in-out ${isChecked ? "bg-primary border-primary" : "bg-white border-gray-300"}`}
        >
          <svg
