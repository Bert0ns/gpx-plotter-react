      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center">
            <div className="rounded-full bg-primary text-primary-foreground w-12 h-12 flex items-center justify-center mb-4 text-xl font-bold">
              1
            </div>
            <h3 className="text-xl font-bold mb-2">Upload GPX Files</h3>
            <p className="text-gray-500 dark:text-gray-400">
              Select one or more .gpx files from your device.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="rounded-full bg-primary text-primary-foreground w-12 h-12 flex items-center justify-center mb-4 text-xl font-bold">
