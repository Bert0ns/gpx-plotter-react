    ...
    <div className="flex justify-center mb-4 lg:scale-110 md:scale-105 scale-95">
      <div className="relative group">
        <button
          ...
          title={title}
          className="relative inline-block p-[2px] font-semibold leading-6 text-white bg-gradient-to-r from-violet-700 to-violet-400 shadow-2xl cursor-pointer rounded-xl shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95"
        >
