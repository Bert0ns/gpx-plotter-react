    ...
    <main>
      <section className="relative flex flex-col items-center w-full py-4 md:py-24 lg:py-32 xl:py-44 text-center container mx-auto max-w-7xl px-4 md:px-6">
        <div
          ...
          style={{
            backgroundImage: "url('/images/LandingPage_background.jpeg')",
          }}
        />
        <div className="relative z-10 space-y-4 ">
          <div className="space-y-2 text-gray-50">
            ...
            <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl dark:text-gray-400">
              Transform your .gpx files into beautiful, interactive elevation
              charts. Perfect for hikers, cyclists, and outdoor enthusiasts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Create beautiful, responsive elevation charts from your .gpx
                files.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Adjust colors, line thickness, and add custom data labels to
                your charts.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Download your charts as high-quality images for sharing or
                printing.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                Ready to Visualize Your Adventures?
              </h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                Start plotting your .gpx files and create stunning elevation
                charts in minutes.
              </p>
            </div>
            <Link href={"/plot"}>
